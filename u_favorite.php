...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US"><!--<![endif]-->
    <head>
        ...
        <title>รายการโปรด| ตลาดอิเล็กทรอนิกส์ปลาแห่งสยาม</title>
        ...
        <br>
                ...
                <?php include 'inc/menu-profile.php'; ?>
                 ...
                 <div class="col-lg-9 col-sm-12">
                               ...
                               <div class="wrap-imagebox style1 v1">
                                <div class="flat-row-title">
                                    <h3>รายการโปรด</h3>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="row">
                                    <div class="owl-carousel-4 style1">
                    ...
                    <a href="#" class="button-bid btn-sm" >ประมูล</a> 
                    <a href="#" class="button-cancel btn-sm" >ยกเลิก</a> 
                    ...
                    <a href="#" class="button-cancel btn-sm" >ยกเลิก</a> 
                                    ...
                                    </div><!-- /.owl-carousel-4 style1 -->

                                </div><!-- /.row -->
                            </div><!-- /.wrap-imagebox style1 -->     
